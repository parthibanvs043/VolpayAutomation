...
public class LocatorCalenderFromDate {

public static void FromDate(WebDriver wd, String pr,  String strStep)
			throws InterruptedException, IOException {
	try {
			boolean isChecked = false;
			wd.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
			wd.findElements(By.cssSelector(pr)).get(1).click();
			WebElement all = wd.findElement(By.className("table-condensed"));
			List<WebElement> roww = all.findElements(By.tagName("tr"));
